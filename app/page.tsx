...
import { Mail, Phone, Award, BookOpen, Briefcase, User, Code, FileText, Shield, ChevronRight, Moon, Sun, PlusCircle, Lightbulb, X, Mountain, Utensils, Book, Heart } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container max-w-[1440px] mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <button
            onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                className={`flex items-center justify-center rounded-full transition-all duration-300 ease-in-out transform text-gray-700 dark:text-gray-200 hover:bg-indigo-50/80 dark:hover:bg-purple-700/30 ${themeButtonHovered ? 'h-14 w-14 scale-110' : 'h-12 w-12'}`}
                aria-label="切换主题"
          >
                {theme === 'dark' 
                  ? <Sun className={`transition-all duration-300 ease-in-out ${themeButtonHovered ? 'h-7 w-7' : 'h-6 w-6'}`} /> 
                  : <Moon className={`transition-all duration-300 ease-in-out ${themeButtonHovered ? 'h-7 w-7' : 'h-6 w-6'}`} />
                }
          </button>
      ...
      <main className="flex-1 pt-20 text-gray-900 dark:text-white">
        {/* Hero Section */}
        <section id="home" className="hero-section py-8 md:py-12 animate-fade-in bg-transparent">
          <div className="container max-w-[1440px] mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full">
              <div className="flex-1 space-y-5 max-w-2xl">
                ...
                <p className="text-3xl text-gray-700 dark:text-gray-100 h-10">
                  <span className="inline-block border-r-2 border-indigo-500 dark:border-purple-500 pr-1 animate-blink-caret">
                    {typingText}
                  </span>
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="text-xl bg-indigo-50/50 dark:bg-white/10 text-indigo-700 dark:text-white border-indigo-200 dark:border-white/20 py-1">
                    24岁
                  </Badge>
                  <Badge variant="outline" className="text-xl bg-indigo-50/50 dark:bg-white/10 text-indigo-700 dark:text-white border-indigo-200 dark:border-white/20 py-1">
                    中共党员
                ...
                <p className="text-gray-700 dark:text-gray-100 max-w-[600px] text-2xl">
                ...
                <div className="flex gap-4 pt-4">
                  <Button
                    ...
                    className="transition-all duration-300 hover:scale-105 bg-indigo-600 hover:bg-indigo-700 dark:bg-purple-600 dark:hover:bg-purple-700 text-white text-xl py-6 px-8"
                  >
                    <Mail className="mr-2 h-6 w-6" /> 联系我
                  </Button>
                  <a 
                    href="/任瑜瑜简历.pdf" 
                    download="任瑜瑜简历.pdf"
                  ...
                  >
                    <Button
                      variant="outline"
                      className="transition-all duration-300 hover:scale-105 bg-indigo-50/50 dark:bg-white/10 text-indigo-700 dark:text-white border-indigo-200 dark:border-white/20 hover:bg-indigo-100 dark:hover:bg-white/20 text-xl py-6 px-8"
                    >
                      <FileText className="mr-2 h-6 w-6" /> 下载简历
                  </Button>
                  </a>
                </div>
              </div>
              <div className="flex-1 flex justify-end animate-float">
                <div className="relative">
                  ...
                  <div className="image-container w-80 h-80 relative border-4 border-indigo-400/50 dark:border-purple-400/50 transition-transform duration-500 hover:scale-105 animate-pulse-slow">
        ...
        {/* 实习经历 Section */}
        <section id="experience" className="py-16 bg-indigo-50/80 dark:bg-purple-800/60">
          <div className="container max-w-[1440px] mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-12">
              <Briefcase className="h-8 w-8 text-indigo-500 dark:text-purple-400" />
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white">实习经历</h2>
            </div>
            ...
            {/* 康明斯 */}
            <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 bg-white/70 dark:bg-white/10 border-indigo-100 dark:border-white/10">
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row">
                  <div className="bg-indigo-100/70 dark:bg-purple-800/50 p-6 md:w-1/4 relative overflow-hidden">
                    {/* 装饰背景元素 */}
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mt-4">
                          ...
                          <div className="bg-gray-50/80 dark:bg-gray-800/50 p-4 rounded-lg border border-indigo-100 dark:border-purple-500/20 hover:shadow-md transition-all duration-300">
                            <div className="flex items-start">
                              <div className="bg-indigo-100 dark:bg-purple-800/60 p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-600 dark:text-purple-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex flex-col md:flex-row items-center mt-4 gap-4">
                          <div className="w-full md:w-2/3">
                            ...
                            <div className="mt-4 flex items-center">
                              ...
                              <span className="text-indigo-600 dark:text-purple-300 font-bold">92%</span>
                            </div>
        ...
        {/* 教育经历 Section */}
        <section id="education" className="py-16 bg-transparent dark:bg-[#1e1b4b]/30">
          <div className="container max-w-[1440px] mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-8">
              <BookOpen className="h-6 w-6 text-indigo-500 dark:text-purple-400" />
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white">教育经历</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <Button variant="ghost" className="mt-4 text-indigo-600 dark:text-indigo-400">
            ...
            <Dialog open={selectedSchool === "sxu"} onOpenChange={() => setSelectedSchool(null)}>
              <DialogContent className="max-w-5xl p-0 overflow-auto max-h-[90vh] transform motion-safe:transition-all motion-safe:duration-300 rounded-[40px]">
                ...
                <div className="sticky top-0 bg-white dark:bg-gray-900 p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center z-10">
                  ...
                  <DialogClose className="h-8 w-8 rounded-full flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800">
                ...
                <div className="p-6 md:p-8">
                  <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                    {/* 左侧信息 */}
                    <div className="md:w-1/3 bg-indigo-50/80 dark:bg-gray-800/50 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-500/20">
                        ...
                        <div className="bg-indigo-50/80 dark:bg-gray-800/50 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-500/20 hover:shadow-md transition-all">
                          ...
                          <ul className="space-y-1">
                            <li className="flex items-start justify-between">
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2022-2023</span>
                            </li>
                            <li className="flex items-start justify-between">
                              <div className="flex items-start gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 dark:bg-indigo-400 mt-1.5"></div>
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2023-2024</span>
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="bg-indigo-50/80 dark:bg-gray-800/50 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-500/20 hover:shadow-md transition-all">
                          ...
                          <ul className="space-y-1">
                            <li className="flex items-start justify-between">
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2019-2020</span>
                            </li>
                            <li className="flex items-start justify-between">
                              <div className="flex items-start gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 dark:bg-indigo-400 mt-1.5"></div>
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2020-2021</span>
                            </li>
                            <li className="flex items-start justify-between">
                              <div className="flex items-start gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 dark:bg-indigo-400 mt-1.5"></div>
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2018-2019</span>
                            </li>
                            <li className="flex items-start justify-between">
                              <div className="flex items-start gap-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 dark:bg-indigo-400 mt-1.5"></div>
                              ...
                              <span className="text-xs text-gray-500 dark:text-gray-400">2021-2022</span>
                            </li>
                          </ul>
                        </div>
        ...
        {/* 技能 Section */}
        <section id="skills" className="py-16 bg-indigo-50/80 dark:bg-purple-800/60 animate-slide-in">
          <div className="container max-w-[1440px] mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-8">
              <Code className="h-6 w-6 text-indigo-500 dark:text-purple-400" />
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white">技能专长</h2>
            </div>
        ...
        {/* 联系方式 Section */}
        <section id="contact" className="py-16 bg-white/80 dark:bg-white/5">
          <div className="container max-w-[1440px] mx-auto px-4">
            <div className="flex items-center justify-center gap-2 mb-8">
              <Mail className="h-6 w-6 text-indigo-500 dark:text-purple-400" />
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white">联系我</h2>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              {/* 左侧联系信息 */}
              <div className="bg-white/40 dark:bg-purple-900/30 rounded-xl p-6 border border-indigo-100 dark:border-purple-500/30 hover:shadow-lg transition-all duration-300">
                <div className="space-y-6">
                  {/* 邮箱 */}
      ...
      {/* Footer */}
      <footer className="border-t border-indigo-200 dark:border-purple-500/20 py-6 bg-transparent dark:bg-[#1e1b4b]/30">
        <div className="container max-w-[1440px] mx-auto px-4 flex justify-center items-center">
